        ...
        <tr>
            ...
            <td>
                ...
                <form action="classType" method="post">
                    <% System.out.println(detail.getTrainNum() );%>
                   ...
                   <button type="submit" class="seat" name="coach" value="<%=coachDetail.getCoachType()  %>">
                            <%= coachDetail.getCoachType() %> AVL- <%= coachDetail.getAvailables() %>
                   </button>
                      <input type="hidden" name="AVL" value="<%=coachDetail.getAvailables() %>">
